...
[Website](https://snapvere.com) · [Download v0.1.6](https://github.com/bren-wp/SNAPVERE/releases/tag/v0.1.6) · [Documentation](docs/README.md) · [Croatian](README.hr.md)
...
SNAPVERE 0.1.6 is built for people who want screenshot tools that stay focused on the job: capture the right pixels, annotate quickly, copy or save locally, and get out of the way.
...
Current release: **SNAPVERE 0.1.6**<br>
Release page: https://github.com/bren-wp/SNAPVERE/releases/tag/v0.1.6
