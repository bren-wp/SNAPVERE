...
[Web stranica](https://snapvere.com) · [Preuzmi v0.1.16](https://github.com/bren-wp/SNAPVERE/releases/tag/v0.1.16) · [Dokumentacija](docs/hr/README.md) · [English](README.md)
...
SNAPVERE 0.1.16 namijenjen je korisnicima koji žele brz i čist screenshot workflow: snimiti točne piksele, označiti ih, kopirati ili spremiti lokalno i nastaviti raditi.
...
Aktualno izdanje: **SNAPVERE 0.1.16**<br>
Izdanje: https://github.com/bren-wp/SNAPVERE/releases/tag/v0.1.16
