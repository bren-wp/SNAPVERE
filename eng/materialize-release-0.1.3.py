#!/usr/bin/env python3
"""Materialize the audited v0.1.3 release workflow from the archived v0.1.2 workflow."""
from pathlib import Path

root = Path(__file__).resolve().parents[1]
source_path = root / ".github" / "release-archive" / "release-0.1.2.yml"
target_path = root / ".github" / "workflows" / "release-0.1.3.yml"
trigger_path = root / ".github" / "release-triggers" / "v0.1.3"

if target_path.exists():
    raise SystemExit("release-0.1.3.yml already exists; refusing to overwrite")
...
print("Materialized audited SNAPVERE v0.1.3 release workflow and main-only publication trigger.")
