...
public static class SnapvereLocalization
{
    ...
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["CaptureFolderDescription"] = "Open the local SNAPVERE folder or jump directly to your recent captures.",
        ["Refresh"] = "Refresh",
    ...
    private static string? TranslateCore(string language, string key)
        => (language, key) switch
        {
            ...
            ("hr", "Capture") => "Snimanje",
            ("hr", "Storage") => "Pohrana",
            ("hr", "CaptureFolder") => "Mapa snimki",
            ("hr", "CaptureFolderDescription") => "Otvorite lokalnu SNAPVERE mapu ili prijeđite izravno na nedavne snimke.",
            ("hr", "Refresh") => "Osvježi",
