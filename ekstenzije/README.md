...
There is no `<all_urls>` permission and no broad `host_permissions` entry. Protected browser pages can reject capture; SNAPVERE reports a controlled error instead of attempting to bypass browser policy.
