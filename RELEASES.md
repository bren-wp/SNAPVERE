...
- Deferred maintenance cleanup now rejects missing/invalid parent-process identity and must acquire the same named Setup mutex after the original parent exits, preventing cleanup from racing a newer install/repair/uninstall operation.
