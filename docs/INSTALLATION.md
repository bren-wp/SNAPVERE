...
Current public release: **v0.1.5**. Published tags and assets are immutable; later `main` hardening is not retroactively part of that release.
...
Current release: https://github.com/bren-wp/SNAPVERE/releases/tag/v0.1.5
