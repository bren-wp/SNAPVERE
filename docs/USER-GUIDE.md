...
SNAPVERE is a local-first capture tool for Windows and modern browsers. The current public release remains v0.1.9; this guide also documents validated unreleased behavior on `main`/active feature branches when explicitly noted.
