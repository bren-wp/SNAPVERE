...
- x64 build i unit-test suite, uključujući paralelno PNG spremanje dviju snimki s istim timestampom i provjeru da Portable startup poruke ne izlažu umetnute privatne putanje iz exception teksta.
