...
Current maintained product line: **SNAPVERE 0.1.3** for Windows and Chrome, Edge, Opera and Firefox.
...
Current release: https://github.com/bren-wp/SNAPVERE/releases/tag/v0.1.3
